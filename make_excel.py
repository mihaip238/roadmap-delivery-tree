...
def main() -> None:
    ...
    lines = [
        ...
        "  Gaps      — items with link_kind = none, plus inferred EPPs that have no features yet.",
        "",
    ...
    set_widths(items_ws, {
        ...
        10: 12, 11: 14, 12: 42, 13: 14, 14: 12, 15: 14, 16: 12, 17: 36, 18: 50,
    })
        ...
        for epp in epps:
            ...
            for feat in children:
                ...
                for st in stories:
                    ...
                    for col, key in ((7, edp.get("key")), (10, epp.get("key")), (16, feat.get("key")), (21, st.get("key"))):
                        link_cell(tree_ws.cell(tr, col), key)
                    for col, key in ((8, edp.get("key")), (11, epp.get("key")), (17, feat.get("key")), (22, st.get("key"))):
                        if key:
    ...
    set_widths(tree_ws, {
        ...
        16: 16, 17: 42, 18: 44, 19: 16, 20: 16,
        21: 16, 22: 42, 23: 44, 24: 14, 25: 14,
    })
