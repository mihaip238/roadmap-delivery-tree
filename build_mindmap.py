...
def slim_time(raw: dict | None) -> dict | None:
    ...
    return {
        ...
        "ownRemainingSec": raw.get("ownRemainingSec"),
        "rolledRemainingSec": raw.get("rolledRemainingSec"),
        ...
        "ownRemaining": raw.get("ownRemaining") or "",
        "rolledRemaining": raw.get("rolledRemaining") or "",
...
def node_issue(kind: str, rec: dict, extra: dict | None = None) -> dict:
    ...
    out = {
        ...
        "statusCategory": rec.get("statusCategory") or "",
...
def compact_item(item: dict) -> dict:
    ...
    out = {
        ...
        "statusCategory": edp.get("statusCategory") or "",
